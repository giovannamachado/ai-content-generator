      ...
      <div className="mb-16 max-w-2xl mx-auto">
        ...
        <div className="relative group">
          ...
          <textarea
            ...
            className="relative z-10 w-full bg-zinc-950 border border-zinc-800 rounded-2xl p-6 text-white text-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all resize-none h-32 shadow-xl placeholder-zinc-500 custom-scrollbar"
